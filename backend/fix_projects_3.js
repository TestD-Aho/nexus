...
let content = fs.readFileSync('src/api/projects.rs', 'utf8');
...
content = content.replace(toRemove, "// For simplicity, let's do it this way:");
...
fs.writeFileSync('src/api/projects.rs', content);
