...
pub struct Project {
    ...
    pub stack: Option<serde_json::Value>, // array of strings
    pub role: Option<String>,
    pub live_url: Option<String>,
    pub repo_url: Option<String>,
    pub media_ids: Option<serde_json::Value>, // array of media uuids
    pub technologies: Option<serde_json::Value>, // array of strings
    pub featured: bool,
    pub published_at: Option<DateTime<Utc>>,
    pub created_at: DateTime<Utc>,
    pub updated_at: DateTime<Utc>,
...
pub struct Skill {
    pub id: Uuid,
    pub name: String,
    pub category: Option<String>, // e.g., Languages, Frameworks, Tools
    pub proficiency: Option<i32>, // 0-100
    pub icon: Option<String>, // fontawesome or similar class
    pub created_at: DateTime<Utc>,
    pub updated_at: DateTime<Utc>,
}
